...
AWS_DEFAULT_ACL = None  # Default access control list (None means private files)
AWS_QUERYSTRING_AUTH = False  # To make files publicly accessible (Optional)
...
# Use S3 for static files and media files
